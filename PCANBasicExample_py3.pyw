...
class PCANBasicExample(object):
    ...
    def InitializeWidgets(self):
        ...
        self.gbMsgFilter = LabelFrame(self.m_Frame, height=GROUPBOX_HEIGHT, width=GROUPBOX_WIDTH,
        ...
        self.gbParameters = LabelFrame(self.m_Frame, height=GROUPBOX_HEIGHT, width=GROUPBOX_WIDTH,
        ...
        self.gbReading = LabelFrame(self.m_Frame, height=GROUPBOX_HEIGHT * 2 + 20, width=GROUPBOX_WIDTH,
        ...
        self.gbWriting = LabelFrame(self.m_Frame, height=GROUPBOX_HEIGHT * 2 + 10, width=GROUPBOX_WIDTH,
                                    text=" Write Messages ")
    ...
    def InitializeConnectionWidgets(self):
        ...
        if (ENABLE_CAN_FD):
            self.chbCanFD = Checkbutton(self.gbConnection, text="CAN-FD", variable=self.m_CanFDCHB,
                                        command=self.chbCanFD_CheckedChanged)
        ...
        self.btnRelease = Button(self.gbConnection, width=8, state=DISABLED, text="Release",
    ...
    def InitializeFilteringWidgets(self):
        ...
        self.chbFilterExt = Checkbutton(self.gbMsgFilter, text="Extended Frame", variable=self.m_FilterExtCHB,
        ...
        self.rdbFilterCustom = Radiobutton(self.gbMsgFilter, anchor=W, width=20, text="Custom (expand)", value=2,
        ...
        self.btnFilterApply = Button(self.gbMsgFilter, width=8, state=DISABLED, text="Apply",
                                     command=self.btnFilterApply_Click)
        self.btnFilterApply.grid(row=1, padx=5, column=6, sticky=W)

        self.btnFilterQuery = Button(self.gbMsgFilter, width=8, state=DISABLED, text="Query",
    ...
    def InitializeConfigurationWidgets(self):
        ...
        self.rdbParamInactive = Radiobutton(self.gbParameters, anchor=W, width=20, text="Inactive", value=0,
                                            variable=self.m_ConfigurationRDB)
        self.rdbParamInactive.grid(row=1, column=2, padx=0, pady=2, sticky=W)

        Label(self.gbParameters, anchor=W, width=20, textvariable=self.m_DeviceIdOrDelay).grid(row=0, column=3,
                                                                                               sticky=W)
        self.nudDeviceIdOrDelay = Spinbox(self.gbParameters, width=15, state=DISABLED, from_=0, to=0x7FF,
                                          textvariable=self.m_DeviceIdOrDelayNUD)
        self.nudDeviceIdOrDelay.grid(row=1, column=3, padx=0, pady=2, sticky=W)

        self.btnParameterSet = Button(self.gbParameters, width=8, state=ACTIVE, text="Set",
                                      command=self.btnParameterSet_Click)
        self.btnParameterSet.grid(row=1, padx=5, column=4, sticky=W)

        self.btnParameterGet = Button(self.gbParameters, width=8, state=ACTIVE, text="Get",
    ...
    def InitializeReadingWidgets(self):
        ...
        # Controls
        #
        self.rdbTimer = Radiobutton(self.gbReading, text="Read using a Timer", value=1, variable=self.m_ReadingRDB,
                                    command=self.rdbTimer_CheckedChanged)
        self.rdbTimer.grid(row=0, column=0, padx=5, pady=2, sticky=W)

        if IS_WINDOWS:
            self.rdbEvent = Radiobutton(self.gbReading, text="Reading using an Event", value=2,
                                        variable=self.m_ReadingRDB, command=self.rdbTimer_CheckedChanged)
        ...
        self.rdbManual = Radiobutton(self.gbReading, text="Manual Read", value=0, variable=self.m_ReadingRDB,
                                     command=self.rdbTimer_CheckedChanged)
        self.rdbManual.grid(row=0, column=2, padx=5, pady=2, sticky=W)

        self.chbShowPeriod = Checkbutton(self.gbReading, width=16, text="Timestamp as period",
        ...
        Label(self.gbReading, anchor=W, text=tempString, bg="#E2E2E3", fg="#000000", font=self.m_ListFont,
              relief=GROOVE).grid(row=1, column=0, columnspan=4, padx=5, sticky="nwes")

        self.lstMessages = tix.TList(self.gbReading, relief=GROOVE, height=5, orient="horizontal", itemtype="text",
                                     font=self.m_ListFont, command=self.btnMsgClear_Click)
    ...
    def InitializeWritingWidgets(self):
        ...
        self.nudLength = Spinbox(self.gbWriting, width=5, from_=0, to=8, textvariable=self.m_LengthNUD,
        ...
        self.chbExtended = Checkbutton(self.gbWriting, text="Extended", variable=self.m_ExtendedCHB,
                                       command=self.txtID_Leave)
        self.chbExtended.grid(row=2, column=17, padx=0, pady=0)

        self.chbRemote = Checkbutton(self.gbWriting, text="RTR", variable=self.m_RemoteCHB,
                                     command=self.chbRemote_CheckedChanged)
        ...
        self.m_CtrlEdits = [self.txtData0, self.txtData1, self.txtData2, self.txtData3, self.txtData4, self.txtData5,
                            self.txtData6, self.txtData7, \
                            self.txtData8, self.txtData9, self.txtData10, self.txtData11, self.txtData12,
                            self.txtData13, self.txtData14, self.txtData15, \
                            self.txtData16, self.txtData17, self.txtData18, self.txtData19, self.txtData20,
                            self.txtData21, self.txtData22, self.txtData23, \
                            self.txtData24, self.txtData25, self.txtData26, self.txtData27, self.txtData28,
                            self.txtData29, self.txtData30, self.txtData31, \
                            self.txtData32, self.txtData33, self.txtData34, self.txtData35, self.txtData36,
                            self.txtData37, self.txtData38, self.txtData39, \
                            self.txtData40, self.txtData41, self.txtData42, self.txtData43, self.txtData44,
                            self.txtData45, self.txtData46, self.txtData47, \
                            self.txtData48, self.txtData49, self.txtData50, self.txtData51, self.txtData52,
                            self.txtData53, self.txtData54, self.txtData55, \
                            self.txtData56, self.txtData57, self.txtData58, self.txtData59, self.txtData60,
                            self.txtData61, self.txtData62, self.txtData63]

        self.m_DataEdits = [self.m_Data0TXT, self.m_Data1TXT, self.m_Data2TXT, self.m_Data3TXT, self.m_Data4TXT,
                            self.m_Data5TXT, self.m_Data6TXT, self.m_Data7TXT, \
                            self.m_Data8TXT, self.m_Data9TXT, self.m_Data10TXT, self.m_Data11TXT, self.m_Data12TXT,
                            self.m_Data13TXT, self.m_Data14TXT, self.m_Data15TXT, \
                            self.m_Data16TXT, self.m_Data17TXT, self.m_Data18TXT, self.m_Data19TXT, self.m_Data20TXT,
                            self.m_Data21TXT, self.m_Data22TXT, self.m_Data23TXT, \
                            self.m_Data24TXT, self.m_Data25TXT, self.m_Data26TXT, self.m_Data27TXT, self.m_Data28TXT,
                            self.m_Data29TXT, self.m_Data30TXT, self.m_Data31TXT, \
                            self.m_Data32TXT, self.m_Data33TXT, self.m_Data34TXT, self.m_Data35TXT, self.m_Data36TXT,
                            self.m_Data37TXT, self.m_Data38TXT, self.m_Data39TXT, \
                            self.m_Data40TXT, self.m_Data41TXT, self.m_Data42TXT, self.m_Data43TXT, self.m_Data44TXT,
                            self.m_Data45TXT, self.m_Data46TXT, self.m_Data47TXT, \
                            self.m_Data48TXT, self.m_Data49TXT, self.m_Data50TXT, self.m_Data51TXT, self.m_Data52TXT,
                            self.m_Data53TXT, self.m_Data54TXT, self.m_Data55TXT, \
                            self.m_Data56TXT, self.m_Data57TXT, self.m_Data58TXT, self.m_Data59TXT, self.m_Data60TXT,
                            self.m_Data61TXT, self.m_Data62TXT, self.m_Data63TXT]
    ...
    def InitializeInformationWidgets(self):
        ...
        self.btnGetVersions = Button(self.gbInfo, width=8, state=DISABLED, text="Versions",
    ...
    def btnHwRefresh_Click(self):
        ...
        # print(result[1].channel_condition)
        if (result[0] == PCAN_ERROR_OK):
            # Include only connectable channels
            #
            for channel in result[1]:
                print(channel.channel_condition, channel.channel_handle,channel.device_features)
    ...
    def btnFilterApply_Click(self):
        ...
        if self.m_FilteringRDB.get() == 2:
            ...
            #
            if result == PCAN_ERROR_OK:
                self.IncludeTextMessage("The filter was customized. IDs from {0:X} to {1:X} will be received".format(
    ...
    def rdbTimer_CheckedChanged(self):
        ...
        if self.m_ReadingRDB.get() == 2:
            if WINDOWS_EVENT_SUPPORT:
                ...
                messagebox.showerror("Module ''win32Event'' not found",
